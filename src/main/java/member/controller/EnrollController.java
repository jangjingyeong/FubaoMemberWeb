...
public class EnrollController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Member member = new Member(memberId, memberPw, memberName, memberAge, memberGender
				, memberEmail, memberPhone, memberAddress, memberHobby);
				
		// 서비스 호출! 
		request.setAttribute(memberName, memberHobby);
		MemberService service = new MemberService();
		// INSERT INTO MEMBER_TBL VAULES(?,?,?,?,?,?,?,?,?,DEFAULT,DEFAULT,DEFAULT)
		// 매개변수가 필요함 
